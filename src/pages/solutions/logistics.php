                                    ...
                                    <ul class="space-y-1">
                                        ...
                                        <li>
                                            <a href="logistics.html"
                                                ...
                                                <div>
                                                    <span
                                                        class="block text-gray-800 font-medium group-hover/item:text-blue-600">Fleet Management</span>
                                                    <span class="text-sm text-gray-500">Delivery Process Management</span>
                                                </div>
                                            </a>
                                        </li>
        ...
        <section class="bg-[#2A0A55] py-16">
            <div class="container mx-auto px-4">
                <div class="max-w-3xl mx-auto text-center">
                    <h2 class="text-3xl font-bold text-white mb-6">Prêt à optimiser vos opérations de livraison ?</h2>
                    <p class="text-gray-200 mb-8">
                        Découvrez comment notre solution peut transformer votre gestion de flotte de livraison.
                    </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="logistics.html" class="text-gray-400 hover:text-white transition-colors">Fleet Management</a></li>
