                                    ...
                                    <ul class="space-y-1">
                                        ...
                                        <li>
                                            <a href="fuel.html"
                                                ...
                                                <div>
                                                    <span
                                                        class="block text-gray-800 font-medium group-hover/item:text-blue-600">Fuel Management</span>
                                                    <span class="text-sm text-gray-500">Consumption Control</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
        ...
        <section class="bg-[#2A0A55] py-16">
            <div class="container mx-auto px-4">
                <div class="max-w-3xl mx-auto text-center">
                    <h2 class="text-3xl font-bold text-white mb-6">Prêt à optimiser votre gestion de carburant ?</h2>
                    <p class="text-gray-200 mb-8">
                        Découvrez comment notre solution peut vous aider à réduire vos coûts de carburant.
                    </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                ...
                <div class="space-y-4">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="fuel.html" class="text-gray-400 hover:text-white transition-colors">Fuel Management</a></li>
                    </ul>
                </div>
