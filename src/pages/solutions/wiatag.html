        ...
        <section class="bg-[#2A0A55] py-16">
            <div class="container mx-auto px-4">
                <div class="max-w-3xl mx-auto text-center">
                    <h2 class="text-3xl font-bold text-white mb-6">Prêt à optimiser la gestion de vos équipes terrain ?</h2>
                    <p class="text-gray-200 mb-8">
                        Découvrez comment WiaTag peut transformer votre gestion d'équipes mobiles.
                    </p>
